...
const BENEFITS = [
  ...
  {
    title: 'Texas VPP Eligible',
    description:
      'Eligible Texas homeowners can receive a free battery through the state\'s Virtual Power Plant program — $0 cost, 20-year warranty.',
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    <main className="min-h-screen bg-[#1e2333] text-white -mx-4 sm:-mx-6 lg:-mx-8">
      ...
      <section className="px-4 pt-20 pb-16 text-center">
        ...
        >
          ...
          >
            No Solar Required · Auto-Backup · TX VPP Eligible
          </span>
